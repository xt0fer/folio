...
type UserORM struct {
	...
	Lastname  string
	ShareId   *uint32
	Thumbnail *AssetORM `gorm:"foreignkey:UserId;association_foreignkey:Id"`
}
...
type ShareORM struct {
	...
	Friend    *UserORM    `gorm:"foreignkey:ShareId;association_foreignkey:Id"`
	Id        uint32
	Thumbnail *AssetORM `gorm:"foreignkey:ShareId;association_foreignkey:Id"`
}
...
type TagORM struct {
	...
	Kind      uint32
	Label     string
	Thumbnail *AssetORM `gorm:"foreignkey:TagId;association_foreignkey:Id"`
}
...
type FolioORM struct {
	AssetId   *uint32
	Assets    []*AssetORM `gorm:"foreignkey:AssetsFolioId;association_foreignkey:Id"`
	Desc      string
	Id        uint32
	Name      string
	NoteId    *uint32
	Notes     []*NoteORM  `gorm:"foreignkey:FolioId;association_foreignkey:Id"`
	Owner     *UserORM    `gorm:"foreignkey:FolioId;association_foreignkey:Id"`
	...
	Thumbnail *AssetORM   `gorm:"foreignkey:ThumbnailFolioId;association_foreignkey:Id"`
	UUID      string
}
...
type NoteORM struct {
	...
	Name      string
	Note      string
	Thumbnail *AssetORM `gorm:"foreignkey:NoteId;association_foreignkey:Id"`
}
...
func DefaultStrictUpdateUser(ctx context.Context, in *User, db *gorm1.DB) (*User, error) {
	...
	filterThumbnail := AssetORM{}
	if ormObj.Id == 0 {
		return nil, errors.New("Can't do overwriting update with no Id value for UserORM")
	}
	filterThumbnail.UserId = new(uint32)
	*filterThumbnail.UserId = ormObj.Id
...
func DefaultApplyFieldMaskUser(ctx context.Context, patchee *User, patcher *User, updateMask *field_mask1.FieldMask, prefix string, db *gorm1.DB) (*User, error) {
	...
	for i, f := range updateMask.Paths {
		...
		if !updatedThumbnail && strings.HasPrefix(f, prefix+"Thumbnail.") {
			...
			if patchee.Thumbnail == nil {
				patchee.Thumbnail = &Asset{}
			}
			if o, err := DefaultApplyFieldMaskAsset(ctx, patchee.Thumbnail, patcher.Thumbnail, &field_mask1.FieldMask{Paths: updateMask.Paths[i:]}, prefix+"Thumbnail.", db); err != nil {
				return nil, err
			} else {
				patchee.Thumbnail = o
			}
		...
		if f == prefix+"Thumbnail" {
			updatedThumbnail = true
			patchee.Thumbnail = patcher.Thumbnail
			continue
		}
	}
	if err != nil {
...
func DefaultStrictUpdateShare(ctx context.Context, in *Share, db *gorm1.DB) (*Share, error) {
	...
	*filterFriend.ShareId = ormObj.Id
	if err = db.Where(filterFriend).Delete(UserORM{}).Error; err != nil {
		return nil, err
	}
	filterThumbnail := AssetORM{}
	if ormObj.Id == 0 {
	...
	filterThumbnail.ShareId = new(uint32)
	*filterThumbnail.ShareId = ormObj.Id
	if err = db.Where(filterThumbnail).Delete(AssetORM{}).Error; err != nil {
		return nil, err
	}
...
func DefaultApplyFieldMaskShare(ctx context.Context, patchee *Share, patcher *Share, updateMask *field_mask1.FieldMask, prefix string, db *gorm1.DB) (*Share, error) {
	...
	for i, f := range updateMask.Paths {
		...
		if !updatedFriend && strings.HasPrefix(f, prefix+"Friend.") {
			...
			if o, err := DefaultApplyFieldMaskUser(ctx, patchee.Friend, patcher.Friend, &field_mask1.FieldMask{Paths: updateMask.Paths[i:]}, prefix+"Friend.", db); err != nil {
				return nil, err
			} else {
				patchee.Friend = o
			}
...
func DefaultStrictUpdateTag(ctx context.Context, in *Tag, db *gorm1.DB) (*Tag, error) {
	...
	filterThumbnail := AssetORM{}
	if ormObj.Id == 0 {
		return nil, errors.New("Can't do overwriting update with no Id value for TagORM")
	}
	filterThumbnail.TagId = new(uint32)
	*filterThumbnail.TagId = ormObj.Id
	if err = db.Where(filterThumbnail).Delete(AssetORM{}).Error; err != nil {
		return nil, err
	}
...
func DefaultStrictUpdateFolio(ctx context.Context, in *Folio, db *gorm1.DB) (*Folio, error) {
	...
	filterAssets.AssetsFolioId = new(uint32)
	*filterAssets.AssetsFolioId = ormObj.Id
	...
	*filterNotes.FolioId = ormObj.Id
	...
	filterOwner.FolioId = new(uint32)
	*filterOwner.FolioId = ormObj.Id
	...
	filterThumbnail.ThumbnailFolioId = new(uint32)
	*filterThumbnail.ThumbnailFolioId = ormObj.Id
	if err = db.Where(filterThumbnail).Delete(AssetORM{}).Error; err != nil {
		return nil, err
	}
...
func DefaultStrictUpdateNote(ctx context.Context, in *Note, db *gorm1.DB) (*Note, error) {
	...
	*filterFolio.NoteId = ormObj.Id
	...
	filterThumbnail.NoteId = new(uint32)
	*filterThumbnail.NoteId = ormObj.Id
	if err = db.Where(filterThumbnail).Delete(AssetORM{}).Error; err != nil {
		return nil, err
	}
